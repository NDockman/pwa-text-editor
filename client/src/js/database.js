...
export const putDb = async (content) => {
  ...
  const dataTransaction = openDatabase.transaction(DB_NAME, 'readwrite');

  // TODO: Now create a variable for the store
  const store = dataTransaction.objectStore(DB_NAME);
...
export const getDb = async () => {
  ...
  const dataTransaction = openDatabase.transaction(DB_NAME, 'readonly');
